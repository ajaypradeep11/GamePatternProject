...
{
    float cameraMoveSpeed = ::g_pFlyCamera->movementSpeed/40;

    float objectMovementSpeed = 5.0f;
    ...
    if ( cGFLWKeyboardModifiers::areAllModsUp(pWindow) )
    {
        ...
        {
            ::g_vec_pMeshes[0]->positionXYZ.y += objectMovementSpeed;
        ...
        {
            ::g_vec_pMeshes[0]->positionXYZ.x += objectMovementSpeed;
